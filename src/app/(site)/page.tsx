...
import calendarBanner from "../../../public/global/cal.png";
import applicationBanner from "../../../public/global/appBanner.png";
  ...
  return (
    <>
      <section className="overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
        ...
        <div className="bg-white mt-6 p-[2px] rounded-xl bg-gradient-to-r from-primary to-brand-primaryBlue sm:w-[300px]">
          <Button 
          ...
          <div className="md:mt-[-90px] sm:w-full w-[750px] flex justify-center items-center mt-[-40px] relative sm:ml-[0px] ml-[-50px]">
            <Image src={applicationBanner} alt="application-banner" width={1000} height={500} />
            <div className="bottom-0 top-[50%] bg-gradient-to-t dark:from-background left-0 right-0 absolute z-10">
          </div>
        </div>
      </section>
      <section className="relative">
        <div className="overflow-hidden flex after:absolute after:content[''] after:dark:from-brand-dark after:to-transparent after:from-background after:bg-gradient-to-l after:right-0 after:bottom-0 after:top-0 after:w-20 after:z-10

        before:content[''] before:dark:from-brand-dark before:to-transparent before:from-background before:bg-gradient-to-r before:top-0 before:left-0 before:bottom-0 before:w-20 before:z-10 before:absolute">
          {[...Array(2)].map((arr) => (
      ...
      <section className="px-4 sm:px-6 flex items-center justify-center flex-col relative">
        ...
        <div className="mt-10 max-w-[450px] flex justify-center items-center relative sm:ml-0 rounded-2xl border-8 border-washed-purple-300 border-opacity-10">
            <Image src={calendarBanner} alt="CalendarBanner" className="rounded-2xl" width={1000} height={500} />
        </div>
      </section>
      <section className="relative">
        ...
        <div className="mt-20 px-4 sm:px-6 flex flex-col overflow-x-hidden overflow-visible ">
          ...
          {[...Array(2)].map((arr, index) => (
            <div key={randomUUID()} className={twMerge(clsx('mt-10 flex flex-nowrap gap-6 self-start ', { 'flex-row-reverse': index === 1, 'animate-[slide_250s_linear_infinite]': true, 'animate-[slide_250s_linear_.infinite_reverse]': false }))}>
      ...
      <section className="mt-20 px-4 sm:px-6">
        <TitleSection title={`The Perfect Plan For You`} subheading={`Experience all the benefits of our platform. Select a plan according to your requirements`} pill={`Pricing`} />
        <div className="flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10">
          {PRICING_CARDS.map((card) => (
            <CustomCard 
              key={card.planType} 
              className={clsx('w-[300px] rounded-2xl dark:bg-black/40 background-blur-3xl relative', {'border-brand-primaryPurple/70': card.planType === PRICING_PLANS.proplan})}
