...
import cipherLogo from '../../../../public/global/cypresslogo.svg';
    ...
    <Form {...form}>
      <form onChange={() => {
        ...
        <Link href="/" className="w-full flex justify-left items-center">
          <Image src={cipherLogo} alt="cipher-logo" width={50} height={50} />
          <span className="font-semibold dark:text-white text-4xl first-letter:ml-2">cipher.</span>
        </Link>
        ...
        <Button type="button" className="w-full p-6" size="lg" disabled={isLoading}>
