...
import logo from '../../../public/global/cypresslogo.svg';
...
const Header = () => {
  ...
  return (
    <header className="p-4 flex justify-center items-center">
      <Link className="w-full justify-start items-center flex gap-x-2" href={'/'}>
        <Image src={logo} alt="cipher-logo" height={25} width={25} />
        <span className="font-semibold dark:text-white">cipher.</span>
      </Link>
      <NavigationMenu className="hidden md:block">
        <NavigationMenuList className="gap-6">
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] ld:w-[500px] lg:grid-cols-[1.75fr_1fr]">
                ...
                <ListItem href='#' title="Introduction">
                  Re-usable components built using TailwindCSS and RadixUI
                </ListItem>
                <ListItem href='#' title="Introduction">
